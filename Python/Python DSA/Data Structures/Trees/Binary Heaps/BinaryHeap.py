...
def heapifyTreeExtract(rootNode, index, heapType):
    ...
    #choosing the left sidse of the heap as per the algorithm
...
def extractedNode(rootNode, heapType):
...
#print(extractedNode(newBH, "Max"))
#extractedNode(newBH, "Max")

deleteBinaryHeap(newBH)
levelOrderTraversal(newBH)